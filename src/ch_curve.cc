...
int main(int argc, char** argv) {
    ...
    ***************/
    ...
    double kappa = Parameters::get<double>("parameters->kappa").value_or(1.0);
    ...
    **************/
    ...
    auto curvatureTerm = zot(- kappa / eps * doubleWell(phi));

    prob.addMatrixOperator(sot(mobility), 0, 1);
    prob.addMatrixOperator(curvatureTerm, 0, 1);
